window.addEventListener('load', function() {
    ...
    var sticky = navbar.offsetTop;
     if(document.title.substring(0,3) != "All"){
     document.getElementById("matchbanner").style.backgroundImage = "url(images/"+document.title.substring(0,document.title.length-17).replace(/\s+/g, '_')+"Banner.png)";
     }
    function myFunction() {
